...
public class GsonLineString {
	private static final Logger log = LoggerFactory.getLogger(GsonLineString.class);
	...
	public LineStringEx toLineString() {
		ArrayList<Point> points = new ArrayList<Point>();
		for (GsonPoint p : this.points) {
			points.add(p.toPoint());
		}
		return new LineStringEx(points.toArray(new Point[points.size()]));
	}
	...
	public void optimizePoints() {
		...
		Collection<GsonPoint> optPoints = new ArrayList<GsonPoint>(this.points.length);
